...
function create( diy ) {
	...
	diy.name = #xw2-huge-ship;
	$Affiliation = #xw2-huge-affiliation;
	$PilotSkill = #xw2-huge-ps;
	
	$ForeDesignation = #xw2-huge-fore-designation;
	$ForeText = #xw2-huge-fore-text;
	$ForeTextFlavor =  #xw2-huge-fore-text-flavor;
	$ForeCrippledText = #xw2-huge-fore-crippled-text;
	$ForeCrippledTextFlavor =  #xw2-huge-fore-crippled-text-flavor;
	$ForePwv = #xw2-huge-fore-pwv;
	$ForeCrippledPwv = #xw2-huge-fore-crippled-pwv;
	$ForeRange = #xw2-huge-fore-range;
	$ForeCrippledRange = #xw2-huge-fore-crippled-range;
	$ForeArc = #xw2-huge-fore-arc;
	$ForeTurret = #xw2-huge-fore-turret;
	$ForeEnergy = #xw2-huge-fore-energy;
	$ForeCrippledEnergy = #xw2-huge-fore-crippled-energy;
	$ForeHull = #xw2-huge-fore-hull;
	$ForeShield = #xw2-huge-fore-shield;
	$ForeRecoverAction = #xw2-huge-fore-recover;
	$ForeReinforceAction = #xw2-huge-fore-reinforce;
	$ForeCoordinateAction = #xw2-huge-fore-coordinate;
	$ForeJamAction = #xw2-huge-fore-jam;
	$ForeLockAction = #xw2-huge-fore-lock;
	$ForeUpgrade1 = #xw2-huge-fore-upgrade-1;
	$ForeUpgrade2 = #xw2-huge-fore-upgrade-2;
	$ForeUpgrade3 = #xw2-huge-fore-upgrade-3;
	$ForeUpgrade4 = #xw2-huge-fore-upgrade-4;
	$ForeUpgrade5 = #xw2-huge-fore-upgrade-5;
	$ForeUpgrade6 = #xw2-huge-fore-upgrade-6;
	$ForeUpgrade7 = #xw2-huge-fore-upgrade-7;
	$ForeCrippledUpgrade1 = #xw2-huge-fore-crippled-upgrade-1;
	$ForeCrippledUpgrade2 = #xw2-huge-fore-crippled-upgrade-2;
	$ForeCrippledUpgrade3 = #xw2-huge-fore-crippled-upgrade-3;
	$ForeCrippledUpgrade4 = #xw2-huge-fore-crippled-upgrade-4;
	$ForeCrippledUpgrade5 = #xw2-huge-fore-crippled-upgrade-5;
	$ForeCrippledUpgrade6 = #xw2-huge-fore-crippled-upgrade-6;
	$ForeCrippledUpgrade7 = #xw2-huge-fore-crippled-upgrade-7;
	$ForeCost = #xw2-huge-fore-cost;
	
	$AftDesignation = #xw2-huge-aft-designation;
	$AftText = #xw2-huge-aft-text;
	$AftTextFlavor = #xw2-huge-aft-text-flavor;
	$AftCrippledText = #xw2-huge-aft-crippled-text;
	$AftCrippledTextFlavor = #xw2-huge-aft-crippled-text-flavor;
	$AftPwv = #xw2-huge-aft-pwv;
	$AftCrippledPwv = #xw2-huge-aft-crippled-pwv;
	$AftRange = #xw2-huge-aft-range;
	$AftCrippledRange = #xw2-huge-aft-crippled-range;
	$AftArc = #xw2-huge-aft-arc;
	$AftTurret = #xw2-huge-aft-turret;
	$AftEnergy = #xw2-huge-aft-energy;
	$AftCrippledEnergy = #xw2-huge-aft-crippled-energy;
	$AftHull = #xw2-huge-aft-hull;
	$AftShield = #xw2-huge-aft-shield;
	$AftRecoverAction = #xw2-huge-aft-recover;
	$AftReinforceAction = #xw2-huge-aft-reinforce;
	$AftCoordinateAction = #xw2-huge-aft-coordinate;
	$AftJamAction = #xw2-huge-aft-jam;
	$AftLockAction = #xw2-huge-aft-lock;
	$AftUpgrade1 = #xw2-huge-aft-upgrade-1;
	$AftUpgrade2 = #xw2-huge-aft-upgrade-2;
	$AftUpgrade3 = #xw2-huge-aft-upgrade-3;
	$AftUpgrade4 = #xw2-huge-aft-upgrade-4;
	$AftUpgrade5 = #xw2-huge-aft-upgrade-5;
	$AftUpgrade6 = #xw2-huge-aft-upgrade-6;
	$AftUpgrade7 = #xw2-huge-aft-upgrade-7;
	$AftCrippledUpgrade1 = #xw2-huge-aft-crippled-upgrade-1;
	$AftCrippledUpgrade2 = #xw2-huge-aft-crippled-upgrade-2;
	$AftCrippledUpgrade3 = #xw2-huge-aft-crippled-upgrade-3;
	$AftCrippledUpgrade4 = #xw2-huge-aft-crippled-upgrade-4;
	$AftCrippledUpgrade5 = #xw2-huge-aft-crippled-upgrade-5;
	$AftCrippledUpgrade6 = #xw2-huge-aft-crippled-upgrade-6;
	$AftCrippledUpgrade7 = #xw2-huge-aft-crippled-upgrade-7;
	$AftCost = #xw2-huge-aft-cost;
	
	$Location = #xw2-huge-location;
	$DoubleSection = #xw2-huge-double;
}
...
function createInterface( diy, editor ) {
	...
	doubleCheckbox = checkBox( @xw2-double-sections );
	bindings.add( 'DoubleSection', doubleCheckbox, [0,1,2,3,4,5] );

	locationItems = [];
	locationItems[0] = ListItem( 'attack-energy', @xw2-location-attack-energy );
	locationItems[1] = ListItem( 'energy-attack', @xw2-location-energy-attack );
	locationItems[2] = ListItem( 'none-energy', @xw2-location-none-energy );
	locationItems[3] = ListItem( 'energy-none', @xw2-location-energy-none );
	...
	iconCardPanel.panelTitle = @xw2-icon-card;	
	
	iconTokenPanel = portraitPanel( diy, 5 );
	iconTokenPanel.setParentPanel( iconCardPanel );		
	iconTokenPanel.panelTitle = @xw2-icon-token;

	commonPanel = new Grid( '', '[min:pref][min:pref,grow][min:pref][min:pref,grow]', '');
	commonPanel.setTitle( @xw2-info );
	commonPanel.place( @xw2-affiliation, '', affiliationBox, 'growx, wrap' );	
	commonPanel.place( @xw2-ship, '', nameField, 'span, growx, wrap' );
	commonPanel.place( doubleCheckbox, 'span, wrap para' );
	commonPanel.place( @xw2-location, '', locationBox, 'growx, wrap' );	
	commonPanel.place( @xw2-ps, '', psBox, 'wmin 52, wrap' );
	...
	// Fore Panel
	foreSectionDesignationItems = [ #xw2-fore-designation ];
	...
	foreTextFlavor = checkBox( @xw2-text-flavor );
	...
	foreCrippledTextFlavor = checkBox( @xw2-text-flavor );
	...
	foreArcItems[1] = ListItem( 'broadside', @xw2-arc-broadside );
	foreArcItems[2] = ListItem( 'extendedBroadside', @xw2-arc-extended-broadside );
	foreArcItems[3] = ListItem( 'front', @xw2-arc-front );
	foreArcItems[4] = ListItem( 'extendedFront', @xw2-arc-extended-front );
	foreArcItems[5] = ListItem( 'fullArc', @xw2-arc-full );
	foreArcBox = comboBox( foreArcItems );
	bindings.add( 'ForeArc', foreArcBox, [4] );

	foreTurret = checkBox( @xw2-turret );
	...
	foreRecoverCheckbox = checkBox( @xw2-action-recover );
	bindings.add( 'ForeRecoverAction', foreRecoverCheckbox, [0,4] );
	foreReinforceCheckbox = checkBox( @xw2-action-reinforce );
	bindings.add( 'ForeReinforceAction', foreReinforceCheckbox, [0,4] );
	foreCoordinateCheckbox = checkBox( @xw2-action-coordinate );
	bindings.add( 'ForeCoordinateAction', foreCoordinateCheckbox, [0,4] );
	foreJamCheckbox = checkBox( @xw2-action-jam );
	bindings.add( 'ForeJamAction', foreJamCheckbox, [0,4] );
	foreLockCheckbox = checkBox( @xw2-action-lock );
	...
	upgradeItems[6] = ListItem( 'illicit', @xw2-upgrade-illicit );
	upgradeItems[7] = ListItem( 'bomb', @xw2-upgrade-bomb );
	upgradeItems[8] = ListItem( 'crew', @xw2-upgrade-crew );
	upgradeItems[9] = ListItem( 'hardpoint', @xw2-upgrade-hardpoint );
	upgradeItems[10] = ListItem( 'team', @xw2-upgrade-team );
	upgradeItems[11] = ListItem( 'cargo', @xw2-upgrade-cargo );
	...
	forePanel.setTitle( @xw2-info );
	forePanel.place( @xw2-designation, '', foreSectionDesignationField, 'span, growx, wrap' );
	forePanel.place( @xw2-text, 'span 2', foreTextFlavor, 'wrap' );
	forePanel.place( foreTextArea, 'span, grow, wrap para' );
	forePanel.place( @xw2-crippledtext, 'span 2', foreCrippledTextFlavor, 'wrap');
	...
	forePanel.place( @xw2-arc, '', foreArcBox, 'wmin 100, span 2, wrap' );
	forePanel.place( foreTurret, 'wrap' );
	forePanel.place( @xw2-pwv, '', forePwvBox, 'wmin 52', @xw2-range, '', foreRangeBox, 'wmin 70, wrap' );
	forePanel.place( @xw2-crippledpwv, '', foreCrippledPwvBox, 'wmin 52', @xw2-range, '', foreCrippledRangeBox, 'wmin 70, wrap' );
	forePanel.place( @xw2-energy, '', foreEnergyBox, 'wmin 52, wrap' );
	forePanel.place( @xw2-crippledenergy, '', foreCrippledEnergyBox, 'wmin 52, wrap' );
	forePanel.place( @xw2-hull, '', foreHullBox, 'wmin 52, wrap' );
	forePanel.place( @xw2-shield, '', foreShieldBox, 'wmin 52, wrap para' );
	forePanel.place( separator(), 'span, growx, wrap para' );
	forePanel.place( @xw2-actions, 'wrap' );
	...
	forePanel.place( separator(), 'span, growx, wrap para' );
	forePanel.place( @xw2-upgrades, 'wmin 100',  @xw2-upgrades-crippled, 'wrap' );
	...
	forePanel.place( separator(), 'span, growx, wrap para' );
	forePanel.place( @xw2-cost, 'span 2', foreCostBox, 'wmin 100, wrap para' );
	forePanel.place( separator(), 'span, growx, wrap para' );
	...
	// Aft Panel
	aftSectionDesignationItems = [ #xw2-aft-designation ];
	...
	aftTextFlavor = checkBox( @xw2-text-flavor );
	...
	aftCrippledTextFlavor = checkBox( @xw2-text-flavor );
	bindings.add( 'AftCrippledTextFlavor', aftCrippledTextFlavor, [3] );
	
	symbolsTagTip2 = tipButton( @xw2-symbol-tooltip );
	headersTagTip2 = tipButton( @xw2-header-tooltip );
	shipsTagTip2 = tipButton( @xw2-ship-tooltip );
	
	aftArcItems = [];
	aftArcItems[0] = ListItem( '-', '-' );
	aftArcItems[1] = ListItem( 'broadside', @xw2-arc-broadside );
	aftArcItems[2] = ListItem( 'extendedBroadside', @xw2-arc-extended-broadside );
	aftArcItems[3] = ListItem( 'rear', @xw2-arc-rear );
	aftArcItems[4] = ListItem( 'extendedRear', @xw2-arc-extended-rear );
	aftArcItems[5] = ListItem( 'fullArc', @xw2-arc-full );
	aftArcBox = comboBox( aftArcItems );
	bindings.add( 'AftArc', aftArcBox, [4] );

	aftTurret = checkBox( @xw2-turret );
	...
	aftRecoverCheckbox = checkBox( @xw2-action-recover );
	bindings.add( 'AftRecoverAction', aftRecoverCheckbox, [2,4] );
	aftReinforceCheckbox = checkBox( @xw2-action-reinforce );
	bindings.add( 'AftReinforceAction', aftReinforceCheckbox, [2,4] );
	aftCoordinateCheckbox = checkBox( @xw2-action-coordinate );
	bindings.add( 'AftCoordinateAction', aftCoordinateCheckbox, [2,4] );
	aftJamCheckbox = checkBox( @xw2-action-jam );
	bindings.add( 'AftJamAction', aftJamCheckbox, [2,4] );
	aftLockCheckbox = checkBox( @xw2-action-lock );
	...
	aftPanel.setTitle( @xw2-info );
	aftPanel.place( @xw2-designation, '', aftSectionDesignationField, 'span, growx, wrap' );
	aftPanel.place( @xw2-text, 'span 2', aftTextFlavor, 'wrap' );
	aftPanel.place( aftTextArea, 'span, grow, wrap para' );
	aftPanel.place( @xw2-crippledtext, 'span 2', aftCrippledTextFlavor, 'wrap');
	...
	aftPanel.place( @xw2-arc, '', aftArcBox, 'wmin 100, span 2, wrap' );
	aftPanel.place( aftTurret, 'wrap' );
	aftPanel.place( @xw2-pwv, '', aftPwvBox, 'wmin 52', @xw2-range, '', aftRangeBox, 'wmin 70, wrap' );
	aftPanel.place( @xw2-crippledpwv, '', aftCrippledPwvBox, 'wmin 52', @xw2-range, '', aftCrippledRangeBox, 'wmin 70, wrap' );
	aftPanel.place( @xw2-energy, '', aftEnergyBox, 'wmin 52, wrap' );
	aftPanel.place( @xw2-crippledenergy, '', aftCrippledEnergyBox, 'wmin 52, wrap' );
	aftPanel.place( @xw2-hull, '', aftHullBox, 'wmin 52, wrap' );
	aftPanel.place( @xw2-shield, '', aftShieldBox, 'wmin 52, wrap para' );
	aftPanel.place( separator(), 'span, growx, wrap para' );
	aftPanel.place( @xw2-actions, 'wrap' );
	...
	aftPanel.place( separator(), 'span, growx, wrap para' );
	aftPanel.place( @xw2-upgrades, 'wmin 100',  @xw2-upgrades-crippled, 'wrap' );
	...
	aftPanel.place( separator(), 'span, growx, wrap para' );
	aftPanel.place( @xw2-cost, 'span 2', aftCostBox, 'wmin 100, wrap para' );
	aftPanel.place( separator(), 'span, growx, wrap para' );
	...
	commonPanel.addToEditor( editor, @xw2-common, null, null, 0 );
	forePanel.addToEditor( editor, @xw2-fore, null, null, 1 );
	aftPanel.addToEditor( editor, @xw2-aft, null, null, 2 );
...
function createFrontPainter( diy, sheet ) {
	...
	//============== Front Sheet ==============
	if( sheet.sheetIndex != 4 ) {
		nameBox = Xwing2.headingBox( sheet, 12.5 );
		epicBox = Xwing2.headingBox( sheet, 12.5 );
...
function paintBack( g, diy, sheet ) {
	...
	// Fore Card Back Face
		if( $$DoubleSection.yesNo ) {
			...
			imageTemplate = 'huge-' + Xwing2.getPrimaryFaction( $Affiliation ) + '-back-template';
...
function paintCardFaceComponents( g, diy, sheet, section, side) {
	...
	//Draw template
	imageTemplate = 'huge-' + Xwing2.getPrimaryFaction( $Affiliation ) + '-' + section + '-template';
	sheet.paintImage( g, imageTemplate, 0, 0);
	...
	sheet.drawOutlinedTitle( g, $PilotSkill, R( section, 'ps' ), Xwing2.numberFont, 18, 2, Xwing2.getColor( 'skill' ), Color.BLACK, sheet.ALIGN_CENTER, true);
	...
	if(	section == 'single' ) {
		...
		range = 'no';
		attributeColor = Xwing2.getColor( 'energy' );
		...
		attributeColor = Xwing2.getColor( 'attack' );
		attributeRegion = R( 'fore', 'attribute' );
		rangeRegion = R( 'fore', 'range' );
		rangeBoxTemplate = 'huge-' + Xwing2.getPrimaryFaction( $Affiliation ) + '-fore-range-box';
		...
		rangeBoxTemplate = 'huge-' + Xwing2.getPrimaryFaction( $Affiliation ) + '-aft-range-box';
	...
	if( range != 'no' ) {
		...
		sheet.drawOutlinedTitle( g, range, rangeRegion, Xwing2.numberFont, 8, 1, Color.WHITE, Color.BLACK, sheet.ALIGN_CENTER, true);
	}
	sheet.paintImage( g, symbolTemplate, symbolRegion );
	sheet.drawOutlinedTitle( g, attributeValue, attributeRegion, Xwing2.numberFont, 14, 1, attributeColor, Color.BLACK, sheet.ALIGN_CENTER, true);
	...
	sheet.drawOutlinedTitle( g, agility, agilityRegion, Xwing2.numberFont, 14, 1, Xwing2.getColor( 'agility' ), Color.BLACK, sheet.ALIGN_CENTER, true);
	...
	sheet.drawOutlinedTitle( g, hull, hullRegion, Xwing2.numberFont, 14, 1, Xwing2.getColor( 'hull' ), Color.BLACK, sheet.ALIGN_CENTER, true);
	...
	sheet.drawOutlinedTitle( g, shield, shieldRegion, Xwing2.numberFont, 14, 1, Xwing2.getColor( 'shield' ), Color.BLACK, sheet.ALIGN_CENTER, true);
	...
	sheet.drawOutlinedTitle( g, cost, R( 'fore', 'cost' ), Xwing2.numberFont, 10, 0.5, Color.BLACK, Color.WHITE, sheet.ALIGN_CENTER, true);
	...
	if( side == 'back' ) {
		imageTemplate = 'huge-' + Xwing2.getPrimaryFaction( $Affiliation ) + '-' + section + '-action-overlay-template';
		sheet.paintImage( g, imageTemplate, 0, 0);
...
function paintTokenComponents( 	g, diy, sheet) {
	...
	// Draw stat panel
	if( tokenSize == 'double' ) {
		sheet.paintImage( g, 'huge-' + Xwing2.getPrimaryFaction( $Affiliation ) + '-fore-panel-template', 47, 0);
	}
	sheet.paintImage( g, 'huge-' + Xwing2.getPrimaryFaction( $Affiliation ) + '-aft-panel-template', 47, tokenHeight-230);
	...
	// Draw the Pilot Skill
	if( tokenSize == 'double' ) {
		sheet.drawOutlinedTitle( g, $PilotSkill, R( 'fore' , 'token-ps'), Xwing2.numberFont, 18, 2, Xwing2.getColor('skill'), Color.BLACK, sheet.ALIGN_CENTER, true);
		sheet.drawOutlinedTitle( g, $PilotSkill, R( 'aft', 'token-ps'), Xwing2.numberFont, 18, 2, Xwing2.getColor('skill'), Color.BLACK, sheet.ALIGN_CENTER, true);
	} else {
		sheet.drawOutlinedTitle( g, $PilotSkill, R( 'single', 'token-ps'), Xwing2.numberFont, 18, 2, Xwing2.getColor('skill'), Color.BLACK, sheet.ALIGN_CENTER, true);
	}
	...
	if( tokenSize == 'double' ) {
		if(	$Location == 'attack-energy' ) {
			...
			attributeForeColor = Xwing2.getColor( 'attack' );
			attributeAftValue = $AftEnergy;
			attributeAftColor = Xwing2.getColor( 'energy' );
		} else if ( $Location == 'energy-attack' ) {
			attributeForeValue = $ForeEnergy;
			attributeForeColor = Xwing2.getColor( 'energy' );
			attributeAftValue = $AftPwv;
			attributeAftColor = Xwing2.getColor( 'attack' );
		...
		sheet.drawOutlinedTitle( g, attributeForeValue, R( 'fore', 'token-attribute'), Xwing2.numberFont, 14, 1, attributeForeColor, Color.BLACK, sheet.ALIGN_CENTER, true);
		sheet.drawOutlinedTitle( g, attributeAftValue, R( 'aft', 'token-attribute'), Xwing2.numberFont, 14, 1, attributeAftColor, Color.BLACK, sheet.ALIGN_CENTER, true);
	} else {
		attributeValue = $ForeEnergy;
		attributeColor = Xwing2.getColor( 'energy' );
		sheet.drawOutlinedTitle( g, attributeValue, R( 'single', 'token-attribute'), Xwing2.numberFont, 14, 1, attributeColor, Color.BLACK, sheet.ALIGN_CENTER, true);
	}

	// Draw the Agility Value
	if( tokenSize == 'double' ) {
		sheet.drawOutlinedTitle( g, '0', R( 'fore', 'token-agi'), Xwing2.numberFont, 14, 1, Xwing2.getColor( 'agility' ), Color.BLACK, sheet.ALIGN_CENTER, true);
		sheet.drawOutlinedTitle( g, '0', R( 'aft', 'token-agi'), Xwing2.numberFont, 14, 1, Xwing2.getColor( 'agility' ), Color.BLACK, sheet.ALIGN_CENTER, true);
	} else {
		sheet.drawOutlinedTitle( g, '0', R( 'single', 'token-agi'), Xwing2.numberFont, 14, 1, Xwing2.getColor( 'agility' ), Color.BLACK, sheet.ALIGN_CENTER, true);
	}

	// Draw the Hull Value
	if( tokenSize == 'double' ) {
		sheet.drawOutlinedTitle( g, $ForeHull, R( 'fore', 'token-hull'), Xwing2.numberFont, 14, 1, Xwing2.getColor( 'hull' ), Color.BLACK, sheet.ALIGN_CENTER, true);
		sheet.drawOutlinedTitle( g, $AftHull, R( 'aft', 'token-hull'), Xwing2.numberFont, 14, 1, Xwing2.getColor( 'hull' ), Color.BLACK, sheet.ALIGN_CENTER, true);
	} else {
		sheet.drawOutlinedTitle( g, $ForeHull, R( 'single', 'token-hull'), Xwing2.numberFont, 14, 1, Xwing2.getColor( 'hull' ), Color.BLACK, sheet.ALIGN_CENTER, true);
	}

	// Draw the Shield Value
	if( tokenSize == 'double' ) {
		sheet.drawOutlinedTitle( g, $ForeShield, R( 'fore', 'token-shield'), Xwing2.numberFont, 14, 1, Xwing2.getColor( 'shield' ), Color.BLACK, sheet.ALIGN_CENTER, true);
		sheet.drawOutlinedTitle( g, $AftShield, R( 'aft', 'token-shield'), Xwing2.numberFont, 14, 1, Xwing2.getColor( 'shield' ), Color.BLACK, sheet.ALIGN_CENTER, true);
	} else {
		sheet.drawOutlinedTitle( g, $ForeShield, R( 'single', 'token-shield'), Xwing2.numberFont, 14, 1, Xwing2.getColor( 'shield' ), Color.BLACK, sheet.ALIGN_CENTER, true);
	}
	...
	for( let i = 0; i < actions.length; ++i ) {
		...
		sheet.drawOutlinedTitle( g, Xwing2.textToIconChar( actions[i] ),  Region( x.toString() + ',' + y.toString() + ',100,100'), Xwing2.iconFont, 15, 1, Xwing2.getColor('imperial'), Color.BLACK, sheet.ALIGN_CENTER, true);
	}
	if( tokenSize == 'double' ) {
		actions = [];
		if( $$AftRecoverAction.yesNo ) { actions.push( 'recover' ); }
