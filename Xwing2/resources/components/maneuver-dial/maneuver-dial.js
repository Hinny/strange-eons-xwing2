...
function createInterface( diy, editor ) {
	...
	maneuverTip = tipButton( @xw2-maneuver-tooltip );

	hugeCheckbox = checkBox( @xw2-huge );
	bindings.add( 'Huge', hugeCheckbox, [2] );

	straightItems = [];
	straightItems[0] = ListItem( 'na', '-' );
	straightItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/green-straight.png' ), 18 ) );
	straightItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-straight.png' ), 18 ) );
	straightItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/red-straight.png' ), 18 ) );

	kTurnItems = [];
	kTurnItems[0] = ListItem( 'na', '-' );
	kTurnItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/green-k-turn.png' ), 18 ) );
	kTurnItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-k-turn.png' ), 18 ) );
	kTurnItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/red-k-turn.png' ), 18 ) );

	leftTurnItems = [];
	leftTurnItems[0] = ListItem( 'na', '-' );
	leftTurnItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/green-left-turn.png' ), 18 ) );
	leftTurnItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-left-turn.png' ), 18 ) );
	leftTurnItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/red-left-turn.png' ), 18 ) );

	rightTurnItems = [];
	rightTurnItems[0] = ListItem( 'na', '-' );
	rightTurnItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/green-right-turn.png' ), 18 ) );
	rightTurnItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-right-turn.png' ), 18 ) );
	rightTurnItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/red-right-turn.png' ), 18 ) );

	leftBankItems = [];
	leftBankItems[0] = ListItem( 'na', '-' );
	leftBankItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/green-left-bank.png' ), 18 ) );
	leftBankItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-left-bank.png' ), 18 ) );
	leftBankItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/red-left-bank.png' ), 18 ) );

	rightBankItems = [];
	rightBankItems[0] = ListItem( 'na', '-' );
	rightBankItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/green-right-bank.png' ), 18 ) );
	rightBankItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-right-bank.png' ), 18 ) );
	rightBankItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/red-right-bank.png' ), 18 ) );

	leftLoopItems = [];
	leftLoopItems[0] = ListItem( 'na', '-' );
	leftLoopItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/green-left-loop.png' ), 18 ) );
	leftLoopItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-left-loop.png' ), 18 ) );
	leftLoopItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/red-left-loop.png' ), 18 ) );

	rightLoopItems = [];
	rightLoopItems[0] = ListItem( 'na', '-' );
	rightLoopItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/green-right-loop.png' ), 18 ) );
	rightLoopItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-right-loop.png' ), 18 ) );
	rightLoopItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/red-right-loop.png' ), 18 ) );

	leftRollItems = [];
	leftRollItems[0] = ListItem( 'na', '-' );
	leftRollItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/green-left-roll.png' ), 18 ) );
	leftRollItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-left-roll.png' ), 18 ) );
	leftRollItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/red-left-roll.png' ), 18 ) );

	rightRollItems = [];
	rightRollItems[0] = ListItem( 'na', '-' );
	rightRollItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/green-right-roll.png' ), 18 ) );
	rightRollItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-right-roll.png' ), 18 ) );
	rightRollItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/red-right-roll.png' ), 18 ) );

	stationaryItems = [];
	stationaryItems[0] = ListItem( 'na', '-' );
	stationaryItems[1] = ListItem( 'green', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/green-stationary.png' ), 18 ) );
	stationaryItems[2] = ListItem( 'white', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-stationary.png' ), 18 ) );
	stationaryItems[3] = ListItem( 'red', '', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/red-stationary.png' ), 18 ) );
	...
	hugeStraightItems[1] = ListItem( '0', '0', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-straight.png' ), 18 ) );
	hugeStraightItems[2] = ListItem( '1', '1', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-straight.png' ), 18 ) );
	hugeStraightItems[3] = ListItem( '2', '2', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-straight.png' ), 18 ) );
	hugeStraightItems[4] = ListItem( '3', '3', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-straight.png' ), 18 ) );
	hugeStraightItems[5] = ListItem( '4', '4', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-straight.png' ), 18 ) );
	hugeStraightItems[6] = ListItem( '5', '5', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-straight.png' ), 18 ) );

	hugeLeftItems = [];
	hugeLeftItems[0] = ListItem( 'na', '-' );
	hugeLeftItems[1] = ListItem( '0', '0', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-left-bank.png' ), 18 ) );
	hugeLeftItems[2] = ListItem( '1', '1', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-left-bank.png' ), 18 ) );
	hugeLeftItems[3] = ListItem( '2', '2', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-left-bank.png' ), 18 ) );
	hugeLeftItems[4] = ListItem( '3', '3', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-left-bank.png' ), 18 ) );
	hugeLeftItems[5] = ListItem( '4', '4', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-left-bank.png' ), 18 ) );
	hugeLeftItems[6] = ListItem( '5', '5', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-left-bank.png' ), 18 ) );

	hugeRightItems = [];
	hugeRightItems[0] = ListItem( 'na', '-' );
	hugeRightItems[1] = ListItem( '0', '0', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-right-bank.png' ), 18 ) );
	hugeRightItems[2] = ListItem( '1', '1', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-right-bank.png' ), 18 ) );
	hugeRightItems[3] = ListItem( '2', '2', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-right-bank.png' ), 18 ) );
	hugeRightItems[4] = ListItem( '3', '3', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-right-bank.png' ), 18 ) );
	hugeRightItems[5] = ListItem( '4', '4', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-right-bank.png' ), 18 ) );
	hugeRightItems[6] = ListItem( '5', '5', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-right-bank.png' ), 18 ) );
	
	hugeStationaryItems = [];
	hugeStationaryItems[0] = ListItem( 'na', '-' );
	hugeStationaryItems[1] = ListItem( '0', '0', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-stationary.png' ), 18 ) );
	hugeStationaryItems[2] = ListItem( '1', '1', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-stationary.png' ), 18 ) );
	hugeStationaryItems[3] = ListItem( '2', '2', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-stationary.png' ), 18 ) );
	hugeStationaryItems[4] = ListItem( '3', '3', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-stationary.png' ), 18 ) );
	hugeStationaryItems[5] = ListItem( '4', '4', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-stationary.png' ), 18 ) );
	hugeStationaryItems[6] = ListItem( '5', '5', ImageUtils.createIcon( ImageUtils.get( 'components/maneuver-dial/images/white-stationary.png' ), 18 ) );
	...
	mainPanel.place( @xw2-affiliation, '', affiliationBox, 'span, growx, wrap' );	
	mainPanel.place( @xw2-ship, '', nameField, 'span, growx, wrap' );
	mainPanel.place( hugeCheckbox, 'span, wrap para' );
	mainPanel.place( separator(), 'span, growx, wrap para' );
	mainPanel.place( @xw2-maneuvers, 'span 3', maneuverTip, 'wrap' );
	mainPanel.place( @xw2-maneuver-speed-5, '', '', '', '', '', '', '', '', '', maneuverBoxS5, '', '', '', '', '', '', '', '', '', maneuverBoxK5, 'wrap' );
	mainPanel.place( @xw2-maneuver-speed-4, '', '', '', '', '', '', '', '', '', maneuverBoxS4, '', '', '', '', '', '', '', '', '', maneuverBoxK4, 'wrap' );
	mainPanel.place( @xw2-maneuver-speed-3, '', maneuverBoxLR3, '', maneuverBoxLL3, '', maneuverBoxLT3, '', maneuverBoxLB3, '', maneuverBoxS3, '', maneuverBoxRB3, '', maneuverBoxRT3, '', maneuverBoxRL3, '', maneuverBoxRR3, '', maneuverBoxK3, 'wrap' );
	mainPanel.place( @xw2-maneuver-speed-2, '', maneuverBoxLR2, '', maneuverBoxLL2, '', maneuverBoxLT2, '', maneuverBoxLB2, '', maneuverBoxS2, '', maneuverBoxRB2, '', maneuverBoxRT2, '', maneuverBoxRL2, '', maneuverBoxRR2, '', maneuverBoxK2, 'wrap' );
	mainPanel.place( @xw2-maneuver-speed-1, '', maneuverBoxLR1, '', maneuverBoxLL1, '', maneuverBoxLT1, '', maneuverBoxLB1, '', maneuverBoxS1, '', maneuverBoxRB1, '', maneuverBoxRT1, '', maneuverBoxRL1, '', maneuverBoxRR1, '', maneuverBoxK1, 'wrap' );
	mainPanel.place( @xw2-maneuver-speed-0, '', '', '', '', '', '', '', '', '', maneuverBox0, '', '', '', '', '', '', '', '', 'wrap para' );
	mainPanel.place( separator(), 'span, growx, wrap para' );
	mainPanel.place( @xw2-huge-maneuvers, 'span 4, wrap' );
	mainPanel.place( @xw2-maneuver-speed-4, '', '', 'span 2', hugeManeuverBoxS4, 'span 2, wmin 80, wrap' );
	mainPanel.place( @xw2-maneuver-speed-3, '', '', 'span 2', hugeManeuverBoxS3, 'span 2, wmin 80, wrap' );
	mainPanel.place( @xw2-maneuver-speed-2, '', hugeManeuverBoxL2, 'span 2, wmin 80', hugeManeuverBoxS2, 'span 2, wmin 80', hugeManeuverBoxR2, 'span 2, wmin 80, wrap' );
	mainPanel.place( @xw2-maneuver-speed-1, '', hugeManeuverBoxL1, 'span 2, wmin 80', hugeManeuverBoxS1, 'span 2, wmin 80', hugeManeuverBoxR1, 'span 2, wmin 80, wrap' );	
	mainPanel.place( @xw2-maneuver-speed-0, '', '', 'span 2', hugeManeuverBox0, 'span 2, wmin 80', '', 'wrap' );	
...
function paintFront( g, diy, sheet ) {
	if( sheet.sheetIndex == 0 ) {
		//============== Upper Front ==============
		imageTemplate =  'maneuver-' + Xwing2.getPrimaryFaction( $Affiliation ) + '-upper-front-template';
		...
		//============== Lower Front ==============
		imageTemplate =  'maneuver-' + Xwing2.getPrimaryFaction( $Affiliation ) + '-lower-front-template';
		sheet.paintImage( g, imageTemplate, 0, 0);
		...
		for( let i=0; i<maneuverArray.length; ++i ) {
			...
			bearingImage = ImageUtils.get( 'components/maneuver-dial/images/' + temp[0] + '.png' );
			speedImage = ImageUtils.get( 'components/maneuver-dial/images/' + temp[1] + '.png' );
			if( $$Huge.yesNo ) {
				energyImage = ImageUtils.get( 'components/maneuver-dial/images/' + temp[2] + '.png' );
				bearingScale = 0.26;
				speedScale = 0.24;
				energyScale = 0.5;
			} else {
...
function paintBack( g, diy, sheet ) {
	if( sheet.sheetIndex == 1 ) {
		//============== Upper Back ==============
		imageTemplate =  'maneuver-' + Xwing2.getPrimaryFaction( $Affiliation ) + '-upper-back-template';
		sheet.paintImage( g, imageTemplate, 0, 0);
	} else {
		//============== Lower Back ==============
		imageTemplate =  'maneuver-' + Xwing2.getPrimaryFaction( $Affiliation ) + '-lower-back-template';
		sheet.paintImage( g, imageTemplate, 0, 0);
	}
}
