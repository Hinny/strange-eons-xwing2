...
var settings;
var xwing2Game = Game.get( 'XW2' );
if( xwing2Game != null ) {
	settings = xwing2Game.masterSettings;
} else {
...
useLibrary( 'project:Xwing2/resources/namedobj.js' );
...
var projBase = 'project:Xwing2/resources/text/';
